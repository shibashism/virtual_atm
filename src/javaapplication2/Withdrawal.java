...
public class Withdrawal extends javax.swing.JFrame{ //implements Runnable {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(jProgressBar1, javax.swing.GroupLayout.PREFERRED_SIZE, 879, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void btnWithdrawalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnWithdrawalActionPerformed
        ...
        if(Withdrawal_textfield.getText().equals("Enter the amount"))
			{
				javax.swing.JOptionPane.showMessageDialog(rootPane, "Field cannot be blank", "Error Withdrawal", getDefaultCloseOperation());
			}
			else
			{
				if( Integer.parseInt(Withdrawal_textfield.getText())>0)//&& !(Withdrawal_textfield.getText().equals("!")))
				{
					...
					{                                            
                                            ...
                                            obj_with.change();
                                            String str="A Withdrawal of INR"+obj_with.num1+ "has been made using your Debit Card linked to SAAD Bank Account on "+sDate+".";                                        
                                            ...
                                            {
                                                bw.append("Username: "+LoginPage.user+" Withdrawed amount: "+obj_with.num1+" on "+sDate);
                                                bw.newLine();
                                            }
                                            catch(IOException e)
                                            {
					...
					{
						if(flag==1)
							javax.swing.JOptionPane.showMessageDialog(rootPane, "You cannot withdraw three times in a streak", "Error",getDefaultCloseOperation());
						else
							javax.swing.JOptionPane.showMessageDialog(rootPane, "Insufficient balance available", "Error",getDefaultCloseOperation());
					}
				}
				else
				{
